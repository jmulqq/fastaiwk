...
results = search_images_ddg('grizzly bear',max_images=200)
...
#    download_images(dest, urls=search_images_ddg(f'{o} bear',max_images=200))
...
get_ipython().system('git clone https://huggingface.co/spaces/jmulqq/test')
